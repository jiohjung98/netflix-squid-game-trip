    ...
    <div className="flex flex-col justify-between items-center h-screen">
      <div className="w-[95%] mt-[1.5rem] text-center"> 
        <p className="text-white mt-[1rem] mb-[1.5rem] font-black z-10" style={{ fontSize: '25px' }}>HOTEL INFORMATION</p>
              ...
              <p className="text-white mb-[1.5rem] font-extrabold z-10" style={{ fontSize: '20px' }}>CHECK-IN PROCESS</p>
              ...
              <p className="text-white mb-[1.5rem] font-extrabold z-10" style={{ fontSize: '20px' }}>HOTEL FACILITIES</p>
