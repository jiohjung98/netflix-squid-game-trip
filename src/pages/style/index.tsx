    ...
    <div className="flex flex-col justify-between items-center h-screen">
      <div className="w-[95%] mt-[1.5rem] text-center"> 
        <p className="text-white mt-[1rem] mb-[1.5rem] font-black" style={{ fontSize: '25px' }}>STYLE GUIDE</p>
              ...
              <div className="netflix-light text-white my-auto font-light" style={{ fontSize: '14px' }}>Casual outfit of your choice</div>
              ...
              <div className="netflix-light text-white mb-[1rem] font-light" style={{ fontSize: '14px' }}>VIP themed attire.<br/>
