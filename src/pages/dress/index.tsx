    ...
    <div className="flex flex-col justify-between items-center h-screen">
      <div className="w-[95%] mt-[1.5rem] text-center"> 
        <p className="text-white mt-[1rem] mb-[1.5rem] font-black" style={{ fontSize: '25px' }}>DRESS CODE</p>
              ...
              <div className="netflix-light font-bold text-white my-auto mb-[1rem]" style={{ fontSize: '14px' }}>May 29</div>
              <div className="netflix-light font-bold text-white my-auto mb-[1rem]" style={{ fontSize: '16px' }}>Welcome Dinner</div>
              ...
              <div className="netflix-light font-bold text-white my-auto mb-[1rem]" style={{ fontSize: '14px' }}>May 30</div>
              <div className="netflix-light font-bold text-white my-auto mb-[1rem]" style={{ fontSize: '16px' }}>Content Capture Day</div>
              ...
              <div className="netflix-light font-bold text-white my-auto mb-[1rem]" style={{ fontSize: '14px' }}>May 31</div>
              <div className="netflix-light font-bold text-white my-auto mb-[1rem]" style={{ fontSize: '16px' }}>Set Visit & Dinner</div>
              <div className="netflix-light text-white my-auto font-light" style={{ fontSize: '14px' }}>Channel your inner VIP from Squid Game<br/>Wear comfortable shoes, no heels,<br/>as you will be walking around the set<br/>VIP facial masks will be give out at the set in Daejeon</div>
