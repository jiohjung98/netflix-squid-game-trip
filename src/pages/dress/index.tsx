    ...
    <div className="flex flex-col justify-between items-center h-screen">
      <div className="w-[95%] mt-[1.5rem] text-center"> 
        <p className="text-white mt-[1rem] mb-[1.5rem] font-black" style={{ fontSize: '25px' }}>DRESS CODE</p>
              ...
              <div className="netflix-light text-white my-auto font-light" style={{ fontSize: '14px' }}>Channel your inner VIP from Squid Game.<br/>Wear comfortable shoes, no heels,<br/>as you will be walking around the set.<br/>VIP facial masks will be given out at the set.<br/>Dress to match the style and mood<br/>of the reference images below.</div>
