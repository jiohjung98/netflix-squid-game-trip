      ...
      <div className="w-[95%] mt-[1.5rem] text-center"> 
        ...
        {currentPage === 2 && (
          <div>
            ...
            <div className="netflix-light text-white font-light" style={{ fontSize: '13px' }}>If you have any delays, please contact<br/>us at the emergency number below.</div>
            <div className="flex justify-center w-full mx-auto gray-500 my-[3rem]">
                <hr className='w-[30%]'></hr>
              </div>
            ...
            <div className="netflix-light text-white my-auto mb-[1rem] font-light" style={{ fontSize: '13px' }}>dongmin.kim@bitecomm.co.kr</div>
            <div className='flex w-full mx-auto justify-center align-items'>
