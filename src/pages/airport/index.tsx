  ...
  return (
    <div className="flex flex-col justify-between items-center h-screen">
      <div className="w-[95%] my-auto mt-[1rem] text-center"> 
        ...
        {currentPage === 2 && (
          <div>
            <p className="netflix-bold text-white mt-[1rem] mb-[1.5rem]" style={{ fontSize: '16px' }}>NETFLIX VAN DEPARTURE TIME</p>
            ...
            <p className="text-white mb-[1.5rem] text-center" style={{ fontSize: '25px' }}>EMERGENCY CONTACT</p>
